...
-- OUT	=>  Location: PIN_A15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- clk	=>  Location: PIN_R8,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF SerialtoSpi IS
...
-- Equation(s):
-- \count~2_combout\ = (\Add0~0_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \count~1_combout\ = (\Add0~22_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \count~5_combout\ = (\Add0~28_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \count~9_combout\ = (\Add0~40_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \count~10_combout\ = (\Add0~42_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \count~11_combout\ = (\Add0~44_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \count~12_combout\ = (!\Equal0~10_combout\ & \Add0~48_combout\)
...
-- Equation(s):
-- \Equal0~7_combout\ = (\Equal0~6_combout\ & (count(22) & (!count(23) & \Equal0~5_combout\)))
...
-- Equation(s):
-- \Equal0~0_combout\ = (count(6) & (!count(5) & (!count(7) & !count(8))))
...
-- Equation(s):
-- \Equal0~1_combout\ = (!count(3) & (!count(4) & (!count(1) & !count(2))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (!count(10) & (!count(0) & (count(11) & !count(9))))
...
-- Equation(s):
-- \OUT~0_combout\ = \OUT~reg0_q\ $ (\Equal0~10_combout\)
